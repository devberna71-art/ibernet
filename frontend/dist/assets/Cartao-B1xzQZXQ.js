import{a as e}from"./chunk-Cyuzqnbw.js";import{n as t,t as n}from"./jsx-runtime-CnYwEvd9.js";import{T as r,d as i}from"./Select-B5NKyy4I.js";import{t as a}from"./Grid-lYkeHmgA.js";import{t as o}from"./Card-DK1kJn6w.js";import{t as s}from"./Checkbox-CpclwTIg.js";import{D as c,H as l,W as u,j as d}from"./index-rMcvf1Zr.js";import{t as f}from"./jspdf.es.min-DkSZDK1J.js";import{t as p}from"./html2canvas-DSKviCCI.js";var m=e(t()),h=e(p()),g=n();function _(){let[e,t]=(0,m.useState)([]),[n,p]=(0,m.useState)([]),[_,v]=(0,m.useState)(null),[y,b]=(0,m.useState)(null),[x,S]=(0,m.useState)(!1),[C,w]=(0,m.useState)(``),[T,E]=(0,m.useState)(``),[D,O]=(0,m.useState)(``),[k,A]=(0,m.useState)(``),[j,M]=(0,m.useState)(1);(0,m.useEffect)(()=>{async function e(){try{t((await c.get(`/membros`)).data)}catch(e){console.log(`Erro (possível 401):`,e)}}e()},[]);let N=e=>{p(t=>t.includes(e)?t.filter(t=>t!==e):[...t,e])},P=e=>{let t=e.target.files[0];t&&v(URL.createObjectURL(t))},F=e=>{let t=e.target.files[0];t&&b(URL.createObjectURL(t))},I=async()=>(await c.post(`/dados-cartao`,{membrosIds:n})).data,L=e.filter(e=>e.nome.toLowerCase().includes(k.toLowerCase())),R=Math.ceil(L.length/6),z=L.slice((j-1)*6,j*6),B=(e,t=!1)=>{let n=x,r=t&&n,i=120+[C,T,D].filter(Boolean).length*20;return`
      <div style="
        width:${n?`900px`:`420px`};
