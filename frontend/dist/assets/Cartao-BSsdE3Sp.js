<<<<<<<< HEAD:frontend/dist/assets/Cartao-DSKdIDn-.js
import{a as e}from"./chunk-Cyuzqnbw.js";import{n as t,t as n}from"./jsx-runtime-CnYwEvd9.js";import{T as r,d as i}from"./Select-B5NKyy4I.js";import{t as a}from"./Grid-BQ2KdeI7.js";import{t as o}from"./Card-DK1kJn6w.js";import{t as s}from"./Checkbox-CpclwTIg.js";import{D as c,H as l,W as u,j as d}from"./index-C-UIZMfk.js";import{t as f}from"./jspdf.es.min-DkSZDK1J.js";import{t as p}from"./html2canvas-DSKviCCI.js";var m=e(t()),h=e(p()),g=n();function _(){let[e,t]=(0,m.useState)([]),[n,p]=(0,m.useState)([]),[_,v]=(0,m.useState)(null),[y,b]=(0,m.useState)(null),[x,S]=(0,m.useState)(!1),[C,w]=(0,m.useState)(``),[T,E]=(0,m.useState)(``),[D,O]=(0,m.useState)(``),[k,A]=(0,m.useState)(``),[j,M]=(0,m.useState)(1);(0,m.useEffect)(()=>{async function e(){try{t((await c.get(`/membros`)).data)}catch(e){console.log(`Erro (possível 401):`,e)}}e()},[]);let N=e=>{p(t=>t.includes(e)?t.filter(t=>t!==e):[...t,e])},P=e=>{let t=e.target.files[0];t&&v(URL.createObjectURL(t))},F=e=>{let t=e.target.files[0];t&&b(URL.createObjectURL(t))},I=async()=>(await c.post(`/dados-cartao`,{membrosIds:n})).data,L=e.filter(e=>e.nome.toLowerCase().includes(k.toLowerCase())),R=Math.ceil(L.length/6),z=L.slice((j-1)*6,j*6),B=(e,t=!1)=>{let n=x,r=t&&n,i=120+[C,T,D].filter(Boolean).length*20;return`
========
import{a as e}from"./chunk-Cyuzqnbw.js";import{n as t,r as n,t as r}from"./axiosConfig-eqyUSZvI.js";import{T as i,d as a}from"./Select-DNqVUCMY.js";import{t as o}from"./Grid-DM5WVLSK.js";import{t as s}from"./Card-CcPpKa6G.js";import{t as c}from"./Checkbox-Ju_YgfeH.js";import{A as l,U as u,V as d}from"./index-BS4tzWF3.js";import{t as f}from"./jspdf.es.min-DkSZDK1J.js";import{t as p}from"./html2canvas-DSKviCCI.js";var m=e(n()),h=e(p()),g=t();function _(){let[e,t]=(0,m.useState)([]),[n,p]=(0,m.useState)([]),[_,v]=(0,m.useState)(null),[y,b]=(0,m.useState)(null),[x,S]=(0,m.useState)(!1),[C,w]=(0,m.useState)(``),[T,E]=(0,m.useState)(``),[D,O]=(0,m.useState)(``),[k,A]=(0,m.useState)(``),[j,M]=(0,m.useState)(1);(0,m.useEffect)(()=>{async function e(){try{t((await r.get(`/membros`)).data)}catch(e){console.log(`Erro (possível 401):`,e)}}e()},[]);let N=e=>{p(t=>t.includes(e)?t.filter(t=>t!==e):[...t,e])},P=e=>{let t=e.target.files[0];t&&v(URL.createObjectURL(t))},F=e=>{let t=e.target.files[0];t&&b(URL.createObjectURL(t))},I=async()=>(await r.post(`/dados-cartao`,{membrosIds:n})).data,L=e.filter(e=>e.nome.toLowerCase().includes(k.toLowerCase())),R=Math.ceil(L.length/6),z=L.slice((j-1)*6,j*6),B=(e,t=!1)=>{let n=x,r=t&&n,i=120+[C,T,D].filter(Boolean).length*20;return`
>>>>>>>> navbar-menu-fix:frontend/dist/assets/Cartao-BSsdE3Sp.js
      <div style="
        width:${n?`900px`:`420px`};
...
========
  `};return(0,g.jsxs)(o,{container:!0,spacing:2,sx:{minHeight:`100vh`,p:2},children:[(0,g.jsx)(o,{item:!0,xs:12,md:6,children:(0,g.jsxs)(s,{sx:{p:3,borderRadius:4},children:[(0,g.jsx)(i,{fontWeight:900,mb:2,children:`Preview do Cartão`}),(0,g.jsx)(a,{dangerouslySetInnerHTML:{__html:B(e[0]||{})}}),(0,g.jsxs)(a,{mt:2,display:`flex`,flexDirection:`column`,gap:1,children:[(0,g.jsx)(l,{label:`Linha 1`,value:C,onChange:e=>w(e.target.value)}),(0,g.jsx)(l,{label:`Linha 2`,value:T,onChange:e=>E(e.target.value)}),(0,g.jsx)(l,{label:`Linha 3`,value:D,onChange:e=>O(e.target.value)})]}),(0,g.jsxs)(a,{sx:{display:`flex`,gap:1,mt:2},children:[(0,g.jsx)(d,{variant:`contained`,onClick:()=>S(!x),children:`Mudar Layout`}),(0,g.jsxs)(d,{component:`label`,children:[`Fundo`,(0,g.jsx)(`input`,{hidden:!0,type:`file`,onChange:P})]}),(0,g.jsxs)(d,{component:`label`,children:[`Logo`,(0,g.jsx)(`input`,{hidden:!0,type:`file`,onChange:F})]})]})]})}),(0,g.jsx)(o,{item:!0,xs:12,md:6,children:(0,g.jsxs)(s,{sx:{p:3,borderRadius:4},children:[(0,g.jsx)(l,{fullWidth:!0,placeholder:`Pesquisar membro...`,value:k,onChange:e=>{A(e.target.value),M(1)},sx:{mb:2}}),(0,g.jsx)(o,{container:!0,spacing:2,children:z.map(e=>(0,g.jsx)(o,{item:!0,xs:12,sm:6,md:4,children:(0,g.jsxs)(s,{onClick:()=>N(e.id),sx:{p:2,borderRadius:4,cursor:`pointer`,transition:`0.3s`,position:`relative`,border:n.includes(e.id)?`2px solid #4f46e5`:`1px solid #e5e7eb`,boxShadow:n.includes(e.id)?`0 10px 25px rgba(79,70,229,0.4)`:`0 5px 15px rgba(0,0,0,0.08)`,"&:hover":{transform:`translateY(-5px)`,boxShadow:`0 12px 30px rgba(0,0,0,0.15)`}},children:[(0,g.jsx)(c,{checked:n.includes(e.id),sx:{position:`absolute`,top:5,right:5}}),(0,g.jsxs)(a,{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:1,children:[(0,g.jsx)(u,{src:e.foto,sx:{width:70,height:70}}),(0,g.jsx)(i,{fontWeight:700,textAlign:`center`,children:e.nome})]})]})},e.id))}),(0,g.jsxs)(a,{mt:2,display:`flex`,justifyContent:`center`,gap:1,children:[(0,g.jsx)(d,{disabled:j===1,onClick:()=>M(j-1),children:`Anterior`}),(0,g.jsxs)(i,{alignSelf:`center`,children:[j,` / `,R||1]}),(0,g.jsx)(d,{disabled:j===R,onClick:()=>M(j+1),children:`Próximo`})]}),(0,g.jsx)(d,{fullWidth:!0,sx:{mt:2,background:`#4f46e5`,color:`#fff`,fontWeight:800},onClick:async()=>{let e=await I(),t=85.6,n=53.98,r=x?t:n,i=x?n:t,a=new f({orientation:x?`landscape`:`portrait`,unit:`mm`,format:[r,i]});for(let t=0;t<e.length;t++){let n=document.createElement(`div`);n.innerHTML=B(e[t],!0),n.style.width=x?`900px`:`420px`,n.style.height=x?`360px`:`650px`,n.style.position=`fixed`,n.style.top=`-9999px`,document.body.appendChild(n);let o=(await(0,h.default)(n,{scale:4,useCORS:!0,backgroundColor:null})).toDataURL(`image/png`),s=document.createElement(`div`);s.innerHTML=V(!0),s.style.width=x?`900px`:`420px`,s.style.height=x?`360px`:`650px`,s.style.position=`fixed`,s.style.top=`-9999px`,document.body.appendChild(s);let c=(await(0,h.default)(s,{scale:4,useCORS:!0,backgroundColor:null})).toDataURL(`image/png`);t>0&&a.addPage([r,i]),a.addImage(o,`PNG`,0,0,r,i),a.addPage([r,i]),a.addImage(c,`PNG`,0,0,r,i),document.body.removeChild(n),document.body.removeChild(s)}a.save(`cartoes.pdf`)},children:`GERAR CARTÕES`})]})})]})}export{_ as default};
>>>>>>>> navbar-menu-fix:frontend/dist/assets/Cartao-BSsdE3Sp.js
